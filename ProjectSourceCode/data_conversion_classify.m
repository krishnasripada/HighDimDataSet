...
f.features = {[],[],[],[],[],[]};
load('/Users/krishnachaitanyasripada/GitHub/highdimensionaldataset/pcaResult/pcaResults_100.mat');
load_ground_truth;
variables = who;
...
clearvars -except f
% Testing Data
load('/Users/krishnachaitanyasripada/GitHub/highdimensionaldataset/testdata/pcaResult/pcaResults_35.mat');
variables = who;
testsample = [];
